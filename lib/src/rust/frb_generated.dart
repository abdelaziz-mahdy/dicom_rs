...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 202520520;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<DicomSlice> crateApiDicomRsInterfaceExtractDicomSlice({
    required String path,
    int? frameIndex,
  });

  Future<List<DicomSlice>> crateApiDicomRsInterfaceExtractDicomSlices({
    required String path,
  });
  ...
  Future<List<DicomSlice>> crateApiDicomRsInterfaceExtractSlicesFromDirectory({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(path, serializer);
          sse_encode_opt_box_autoadd_u_32(frameIndex, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 28,
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_dicom_slice,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiDicomRsInterfaceExtractDicomSliceConstMeta,
        argValues: [path, frameIndex],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiDicomRsInterfaceExtractDicomSliceConstMeta =>
      const TaskConstMeta(
        debugName: "extract_dicom_slice",
        argNames: ["path", "frameIndex"],
      );
  ...
  Future<List<DicomSlice>> crateApiDicomRsInterfaceExtractDicomSlices({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_dicom_slice,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiDicomRsInterfaceExtractDicomSlicesConstMeta,
        argValues: [path],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiDicomRsInterfaceExtractDicomSlicesConstMeta =>
      const TaskConstMeta(
        debugName: "extract_dicom_slices",
        argNames: ["path"],
      );
  ...
  Future<List<DicomSlice>> crateApiDicomRsInterfaceExtractSlicesFromDirectory({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiDicomRsInterfaceExtractSlicesFromDirectoryConstMeta,
  ...
  TaskConstMeta
  get kCrateApiDicomRsInterfaceExtractSlicesFromDirectoryConstMeta =>
      const TaskConstMeta(
        debugName: "extract_slices_from_directory",
