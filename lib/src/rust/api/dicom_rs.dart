...
Future<DicomFile>  loadDicomFile({required String path }) => RustLib.instance.api.crateApiDicomRsLoadDicomFile(path: path);

/// Extracts pixel data from a DICOM file
Future<DicomImage>  extractPixelData({required String path }) => RustLib.instance.api.crateApiDicomRsExtractPixelData(path: path);

/// Gets a specific tag value from a DICOM file
Future<DicomValueType>  getTagValue({required String path , required String tagName }) => RustLib.instance.api.crateApiDicomRsGetTagValue(path: path, tagName: tagName);

/// Check if a file is a valid DICOM file
Future<bool>  isDicomFile({required String path }) => RustLib.instance.api.crateApiDicomRsIsDicomFile(path: path);

/// Get a list of all DICOM tags in a file
Future<List<String>>  listAllTags({required String path }) => RustLib.instance.api.crateApiDicomRsListAllTags(path: path);

/// Get encoded image bytes (PNG format) from a DICOM file
Future<Uint8List>  getEncodedImage({required String path }) => RustLib.instance.api.crateApiDicomRsGetEncodedImage(path: path);

/// Load all DICOM files from a directory
Future<List<DicomDirectoryEntry>>  loadDicomDirectory({required String dirPath }) => RustLib.instance.api.crateApiDicomRsLoadDicomDirectory(dirPath: dirPath);

/// Load all DICOM files recursively from a directory
Future<List<DicomDirectoryEntry>>  loadDicomDirectoryRecursive({required String dirPath }) => RustLib.instance.api.crateApiDicomRsLoadDicomDirectoryRecursive(dirPath: dirPath);
...
class DicomHandler with _$DicomHandler  {
                ...
                static Future<DicomHandler>  default_()=>RustLib.instance.api.crateApiDicomRsDicomHandlerDefault();


/// Gets a list of all tags in a DICOM file
 Future<List<DicomTag>>  getAllTags({required String path })=>RustLib.instance.api.crateApiDicomRsDicomHandlerGetAllTags(that: this, path: path);


/// Gets image bytes encoded as PNG from a DICOM file
 Future<Uint8List>  getImageBytes({required String path })=>RustLib.instance.api.crateApiDicomRsDicomHandlerGetImageBytes(that: this, path: path);


/// Gets all metadata from a DICOM file
 Future<DicomMetadata>  getMetadata({required String path })=>RustLib.instance.api.crateApiDicomRsDicomHandlerGetMetadata(that: this, path: path);


/// Extracts raw pixel data from a DICOM file
 Future<DicomImage>  getPixelData({required String path })=>RustLib.instance.api.crateApiDicomRsDicomHandlerGetPixelData(that: this, path: path);


/// Gets the value of a specific tag
 Future<DicomValueType>  getTagValue({required String path , required String tagName })=>RustLib.instance.api.crateApiDicomRsDicomHandlerGetTagValue(that: this, path: path, tagName: tagName);


/// Checks if a file is a valid DICOM file
 Future<bool>  isValidDicom({required String path })=>RustLib.instance.api.crateApiDicomRsDicomHandlerIsValidDicom(that: this, path: path);


/// Gets a list of all tag names in a DICOM file
 Future<List<String>>  listTags({required String path })=>RustLib.instance.api.crateApiDicomRsDicomHandlerListTags(that: this, path: path);


/// Loads all DICOM files from a directory (non-recursive)
 Future<List<DicomDirectoryEntry>>  loadDirectory({required String path })=>RustLib.instance.api.crateApiDicomRsDicomHandlerLoadDirectory(that: this, path: path);


/// Loads all DICOM files from a directory recursively
 Future<List<DicomDirectoryEntry>>  loadDirectoryRecursive({required String path })=>RustLib.instance.api.crateApiDicomRsDicomHandlerLoadDirectoryRecursive(that: this, path: path);


/// Loads a DICOM file and returns detailed information
 Future<DicomFile>  loadFile({required String path })=>RustLib.instance.api.crateApiDicomRsDicomHandlerLoadFile(that: this, path: path);


  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
/// Creates a new DicomHandler instance
static Future<DicomHandler>  newInstance()=>RustLib.instance.api.crateApiDicomRsDicomHandlerNew();
