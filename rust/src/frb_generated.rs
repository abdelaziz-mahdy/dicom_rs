...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1249002966;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__dicom_rs_interface__dicom_handler_get_all_tags_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__dicom_rs_interface__dicom_handler_get_image_bytes_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        3 => wire__crate__api__dicom_rs_interface__dicom_handler_get_metadata_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        4 => wire__crate__api__dicom_rs_interface__dicom_handler_get_pixel_data_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        5 => wire__crate__api__dicom_rs_interface__dicom_handler_get_tag_value_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        6 => wire__crate__api__dicom_rs_interface__dicom_handler_is_valid_dicom_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__dicom_rs_interface__dicom_handler_list_tags_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        8 => wire__crate__api__dicom_rs_interface__dicom_handler_load_directory_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        9 => wire__crate__api__dicom_rs_interface__dicom_handler_load_directory_recursive_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        10 => wire__crate__api__dicom_rs_interface__dicom_handler_load_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        11 => wire__crate__api__dicom_rs_interface__dicom_handler_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__api__dicom_rs_interface__extract_pixel_data_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__crate__api__dicom_rs_interface__get_encoded_image_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__dicom_rs_interface__get_tag_value_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        18 => wire__crate__api__dicom_rs_interface__list_all_tags_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        19 => wire__crate__api__dicom_rs_interface__load_dicom_directory_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__dicom_rs_interface__load_dicom_directory_recursive_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__dicom_rs_interface__load_dicom_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
