...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1389215581;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        13 => wire__crate__api__dicom_rs_interface__dicom_handler_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__dicom_rs_interface__extract_pixel_data_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__dicom_rs_interface__get_encoded_image_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__dicom_rs_interface__is_dicom_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        17 => wire__crate__api__dicom_rs_interface__load_dicom_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
